# CMPSC 100: Fall 2020, Week 10

* Distributed: 9 November 2020
...
```
git clone git@github.com:allegheny-college-cmpsc-100-fall-2020/cmpsc-100-fall-2020-week-10-image-manipulation-dluman
```
...
* [Week 10, Worksheet: Image Manipulation](worksheets/)
...
- [ ] `cd` to your `~` folder
- [ ] Locate your `cmpsc-100-fall-2020-week-10-image-manipulation` folder and `cd` to it.
